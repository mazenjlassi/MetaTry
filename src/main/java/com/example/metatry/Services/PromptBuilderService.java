...
public class PromptBuilderService {
    ...
    public String buildPlatformPrompt(
        ...
        prompt.append("      \"imagePrompt\": \"Detailed, specific, visually compelling image description for this post\"\n");
        prompt.append("    },\n");
        prompt.append("    {\n");
        prompt.append("      \"title\": \"Another post title\",\n");
        prompt.append("      \"content\": \"Another post content\",\n");
        prompt.append("      \"hashtags\": [\"tag1\", \"tag2\"],\n");
        prompt.append("      \"imagePrompt\": \"Image description for this post\"\n");
        prompt.append("    }\n");
        prompt.append("  ]\n");
        prompt.append("}\n\n");
